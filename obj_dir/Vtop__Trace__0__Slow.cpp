...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+61,"a0", false,-1, 16,0);
    ...
    tracep->declBus(c+15,"Data_RD", false,-1, 31,0);
    tracep->declBus(c+18,"new_addr", false,-1, 31,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("encoder ");
    tracep->declBus(c+62,"Wid", false,-1, 31,0);
    tracep->declBit(c+4,"EQ", false,-1);
    tracep->declBus(c+13,"instr", false,-1, 31,0);
    tracep->declBit(c+5,"RegWrite", false,-1);
    tracep->declBit(c+8,"ResultSrc", false,-1);
    ...
    for (int i = 0; i < 32; ++i) {
        tracep->declBus(c+26+i*1,"reg_file", true,(i+0), 31,0);
    }
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+15,(((((0xfffU >= (0x1fffU 
                                            & ((IData)(3U) 
    ...
    bufp->fullIData(oldp+18,(((IData)(0x1000U) + vlSelf->top__DOT__ALUout)),32);
    ...
    bufp->fullCData(oldp+24,((0x1fU & (vlSelf->top__DOT__instr 
                                       >> 7U))),5);
    bufp->fullIData(oldp+25,(vlSelf->top__DOT__register_file__DOT__reg_file
                             [0xaU]),32);
    bufp->fullIData(oldp+26,(vlSelf->top__DOT__register_file__DOT__reg_file[0]),32);
    bufp->fullIData(oldp+27,(vlSelf->top__DOT__register_file__DOT__reg_file[1]),32);
    bufp->fullIData(oldp+28,(vlSelf->top__DOT__register_file__DOT__reg_file[2]),32);
    bufp->fullIData(oldp+29,(vlSelf->top__DOT__register_file__DOT__reg_file[3]),32);
    bufp->fullIData(oldp+30,(vlSelf->top__DOT__register_file__DOT__reg_file[4]),32);
    bufp->fullIData(oldp+31,(vlSelf->top__DOT__register_file__DOT__reg_file[5]),32);
    bufp->fullIData(oldp+32,(vlSelf->top__DOT__register_file__DOT__reg_file[6]),32);
    bufp->fullIData(oldp+33,(vlSelf->top__DOT__register_file__DOT__reg_file[7]),32);
    bufp->fullIData(oldp+34,(vlSelf->top__DOT__register_file__DOT__reg_file[8]),32);
    bufp->fullIData(oldp+35,(vlSelf->top__DOT__register_file__DOT__reg_file[9]),32);
    bufp->fullIData(oldp+36,(vlSelf->top__DOT__register_file__DOT__reg_file[10]),32);
    bufp->fullIData(oldp+37,(vlSelf->top__DOT__register_file__DOT__reg_file[11]),32);
    bufp->fullIData(oldp+38,(vlSelf->top__DOT__register_file__DOT__reg_file[12]),32);
    bufp->fullIData(oldp+39,(vlSelf->top__DOT__register_file__DOT__reg_file[13]),32);
    bufp->fullIData(oldp+40,(vlSelf->top__DOT__register_file__DOT__reg_file[14]),32);
    bufp->fullIData(oldp+41,(vlSelf->top__DOT__register_file__DOT__reg_file[15]),32);
    bufp->fullIData(oldp+42,(vlSelf->top__DOT__register_file__DOT__reg_file[16]),32);
    bufp->fullIData(oldp+43,(vlSelf->top__DOT__register_file__DOT__reg_file[17]),32);
    bufp->fullIData(oldp+44,(vlSelf->top__DOT__register_file__DOT__reg_file[18]),32);
    bufp->fullIData(oldp+45,(vlSelf->top__DOT__register_file__DOT__reg_file[19]),32);
    bufp->fullIData(oldp+46,(vlSelf->top__DOT__register_file__DOT__reg_file[20]),32);
    bufp->fullIData(oldp+47,(vlSelf->top__DOT__register_file__DOT__reg_file[21]),32);
    bufp->fullIData(oldp+48,(vlSelf->top__DOT__register_file__DOT__reg_file[22]),32);
    bufp->fullIData(oldp+49,(vlSelf->top__DOT__register_file__DOT__reg_file[23]),32);
    bufp->fullIData(oldp+50,(vlSelf->top__DOT__register_file__DOT__reg_file[24]),32);
    bufp->fullIData(oldp+51,(vlSelf->top__DOT__register_file__DOT__reg_file[25]),32);
    bufp->fullIData(oldp+52,(vlSelf->top__DOT__register_file__DOT__reg_file[26]),32);
    bufp->fullIData(oldp+53,(vlSelf->top__DOT__register_file__DOT__reg_file[27]),32);
    bufp->fullIData(oldp+54,(vlSelf->top__DOT__register_file__DOT__reg_file[28]),32);
    bufp->fullIData(oldp+55,(vlSelf->top__DOT__register_file__DOT__reg_file[29]),32);
    bufp->fullIData(oldp+56,(vlSelf->top__DOT__register_file__DOT__reg_file[30]),32);
    bufp->fullIData(oldp+57,(vlSelf->top__DOT__register_file__DOT__reg_file[31]),32);
    bufp->fullIData(oldp+58,(vlSelf->top__DOT__register_file__DOT__WD3),32);
    bufp->fullBit(oldp+59,(vlSelf->clk));
    bufp->fullBit(oldp+60,(vlSelf->rst));
    bufp->fullIData(oldp+61,(vlSelf->a0),17);
    ...
    bufp->fullCData(oldp+69,(vlSelf->top__DOT__encoder__DOT__funct7),7);
}
