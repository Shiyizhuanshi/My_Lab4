...
VL_INLINE_OPT void Vtop___024root___sequent__TOP__0(Vtop___024root* vlSelf) {
                                ...
                                << 0x18U) | ((vlSelf->top__DOT__instr_mem__DOT__rom_array
                                             ...
                                             | ((vlSelf->top__DOT__instr_mem__DOT__rom_array
                                                ...
                                                [(0xffU 
                                                  & ((IData)(3U) 
                                                     + vlSelf->top__DOT__PC))])));
    vlSelf->top__DOT__RegWrite = ((0x13U == (0x7fU 
                                             & vlSelf->top__DOT__instr)) 
                                  | ((0x63U != (0x7fU 
                                                & vlSelf->top__DOT__instr)) 
                                     & (3U == (0x7fU 
    ...
    vlSelf->top__DOT____Vcellout__encoder__ALUctrl 
        = (7U & ((0x13U == (0x7fU & vlSelf->top__DOT__instr))
                      ...
                      : ((3U == (0x7fU & vlSelf->top__DOT__instr))
                          ? (vlSelf->top__DOT__instr 
                             >> 0xcU) : (vlSelf->top__DOT__instr 
                                         >> 0xcU)))));
    vlSelf->top__DOT__ALUsrc = ((0x13U == (0x7fU & vlSelf->top__DOT__instr)) 
                                | ((0x63U != (0x7fU 
                                              & vlSelf->top__DOT__instr)) 
                                   & (3U == (0x7fU 
                                             & vlSelf->top__DOT__instr))));
    ...
    vlSelf->top__DOT__ImmSrc = ((0x13U == (0x7fU & vlSelf->top__DOT__instr)) 
                                | (0x63U != (0x7fU 
                                             & vlSelf->top__DOT__instr)));
    vlSelf->top__DOT__ImmOp = (IData)(((IData)(vlSelf->top__DOT__ImmSrc)
                                        ? (QData)((IData)(
                                                          (((- (IData)(
                                                                       (vlSelf->top__DOT__instr 
                                                                        >> 0x1fU))) 
    ...
    vlSelf->top__DOT__PCsrc = ((0x13U != (0x7fU & vlSelf->top__DOT__instr)) 
                               & ((0x63U == (0x7fU 
                                             & vlSelf->top__DOT__instr)) 
